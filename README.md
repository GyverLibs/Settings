...
- `Slider` - строка результата кликабельная, можно задать значение вручную, оно подчиняется настройкам min/max/step. Прокрутка колесом мыши по слайдеру двигает слайдер
